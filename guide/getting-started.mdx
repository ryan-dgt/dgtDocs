...
Invite [ryan@dogoodthi](mailto:ryan@dogoodthigns.co.nz)ngslco.nz to the following accounts:

- **Google Analytics 4.** Admin access for 
...
- **Microsoft Advertising (Bing Ads).** Admin access please. If you don't have an account yet, we'll create one in your name. 
- **Meta Business Manager.** Access to the ad account, page, pixel or dataset, and catalogue if you have one.
- **Bing Webmaster Console.** Admin access to your bind Webmaster Console (this is where we measure ChatGPT traffic too) 
