---
title: "Getting started: the pre-kickoff access and assets list"
description: "The pre-kickoff checklist for new clients: read-only access to GA4, Google Ads, Meta, GTM, CMS, and email, plus brand assets and unit economics."
icon: "list-check"
---
