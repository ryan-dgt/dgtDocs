...
description: "The complete pre-kickoff checklist: account access (GA4, Google Ads, Meta, GTM, your CMS and email platform), brand assets, and unit economics. Most clients clear it in under an hour."
icon: "list-check"
---
